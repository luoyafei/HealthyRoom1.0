				...
				<div class="col-sm-3 col-md-2 sidebar">
					<div style="width: 80%;height: 30%;margin: 0 auto;margin-bottom: 20%;">
						...
						<div style="width: 75%; height: 75%;margin: 0 auto; margin-bottom: 10px;">
							<img class="img-circle" id="userpicture" style="width: 100%; height: 100%;" alt="" src="/HealthyRoom1.0/userassets/userPhoto/<%=userName %>.jpg" />
						</div>
...
//System.out.println(roleIdStr);
				...
				<div class="tab-content">
					...
					int allThemeItems = UserManager.getInstance().getAllThemeItems();//获取所有的主题
...
//System.out.println(itemId);
						...
						for(int i=1; i <= allButtons; i++) {
							if(itemId == i)
								out.print("<li class='active'><a href='/HealthyRoom1.0/pages/healthyforum/healthyforum.jsp?itemId=" + i + "'>" + i + "</a></li>");
							else
								out.print("<li><a href='/HealthyRoom1.0/pages/healthyforum/healthyforum.jsp?itemId=" + i + "'>" + i + "</a></li>");
						}
//System.out.println(allButtons + "," + itemId);						
						if(itemId == allButtons)//当输入为总数时，将下一页按钮禁止
							out.print("<li class='disabled'><a>&rarr;</a></li>");
						else
							out.print("<li><a href='/HealthyRoom1.0/pages/healthyforum/healthyforum.jsp?itemId=" + (itemId+1) + "'>&rarr;</a></li>");
					%>
					    ...
					    <script>
					    	function submitItemId() {
					    		window.location.href = "/HealthyRoom1.0/pages/healthyforum/healthyforum.jsp?itemId="+$("#jump").val().trim();
					    	}
					    </script>
					  </ul>
					</nav>
