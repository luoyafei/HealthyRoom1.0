											...
											<div class="form-horizontal" style="margin-left: 0px;">
												...
												<div style="border-bottom: dashed #A9A9A9 1px;">
													<div class="form-group"
														...
														<div class="col-sm-10">
															<img alt="" src="/HealthyRoom1.0/business_healthyroomUp/img/<%=tel+"0" %>.jpg" style="width:30%; height: 180px;">
															<img alt="" src="/HealthyRoom1.0/business_healthyroomUp/img/<%=tel+"1" %>.jpg" style="width:30%; height: 180px;">
															<img alt="" src="/HealthyRoom1.0/business_healthyroomUp/img/<%=tel+"2" %>.jpg" style="width:30%; height: 180px;">
														</div>
													</div>
												</div>
